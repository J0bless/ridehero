(function(api) {
  ...
  var lightningSource = 'https://disneyland.disney.go.com/lightning-lane-passes/';
  var lightningLaneIds = {
    'its-a-small-world':1,'mickey-minnies-runaway-railway':1,'space-mountain':1,'big-thunder-mountain-railroad':1,'matterhorn-bobsleds':1,
    'indiana-jones-adventure':1,'rise-of-the-resistance':1,'millennium-falcon-smugglers-run':1,'tianas-bayou-adventure':1,'haunted-mansion':1,'buzz-lightyear-astro-blasters':1,
    'radiator-springs-racers':1,'incredicoaster':1,'guardians-mission-breakout':1,'web-slingers':1,'soarin-across-america':1,'toy-story-midway-mania':1,
    'goofys-sky-school':1,'grizzly-river-run':1,'monsters-inc':1,'little-mermaid':1
  };
  api.register({ parks: {
  ...
  function ride(parkId, id, name, landId, height) { var hasMinimum=Number.isFinite(height), hasLightning=lightningLaneIds[id]===1; return { id: parkId + '-' + id, providerId: null, parkId: parkId, landId: landId, name: name, normalizedName: api.normalize(name), type: 'ride', classification: 'ride', operatingStatus: 'UNKNOWN', latitude: null, longitude: null, minimumHeight: null, minimumHeightInches: hasMinimum ? height : null, minimumHeightCm: hasMinimum ? Math.round(height * 2.54) : null, restrictionType: hasMinimum ? 'minimum-height' : 'none', restrictionsVerified: true, restrictionsSourceUrl: restrictionSource, restrictionsSourceName: 'Disneyland Resort', restrictionsLastVerified: verified, accessPrograms:{lightningLane:hasLightning}, accessProgramConfidence:{lightningLane:'verified'}, accessProgramsSourceUrl:lightningSource, accessProgramsLastVerified:verified, thrillCategory: null, indoorOutdoor: 'unknown', singleRider: null, childSwap: null, expressEligibility: null, source: source, lastVerified: verified }; }
