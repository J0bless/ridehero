(function(api) {
  ...
  var rows = [
    ['mario-kart','Mario Kart: Koopa’s Challenge','SUPER NINTENDO WORLD',107,122],['yoshis-adventure','Yoshi’s Adventure','SUPER NINTENDO WORLD',92,122],
    ['mine-cart-madness','Mine Cart Madness','SUPER NINTENDO WORLD',107,122],['forbidden-journey','Harry Potter and the Forbidden Journey','The Wizarding World of Harry Potter',122,122],
    ['flight-hippogriff','Flight of the Hippogriff','The Wizarding World of Harry Potter',92,122,195],['minion-mayhem','Despicable Me: Minion Mayhem','Minion Park',102,122],
    ['freeze-ray-sliders','Freeze Ray Sliders','Minion Park',92,122],['flying-dinosaur','The Flying Dinosaur','Jurassic Park',132,132,198],
    ['jurassic-park-ride','Jurassic Park – The Ride','Jurassic Park',107,122],['hollywood-dream','Hollywood Dream – The Ride','Hollywood',132,132],
