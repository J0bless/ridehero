...
assert.match(css, /\.coaster-train\.rebuilt-train \.train-car,[\s\S]*width:26px!important;[\s\S]*border-radius:12px 13px 8px 8px!important/, 'coaster cars must use the slimmer rounded artwork');
