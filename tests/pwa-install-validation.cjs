...
assert.match(html, /js\/auth-client\.js\?v=5/, 'the OAuth callback client must use the current cache-busting version');
assert.match(worker, /\.\/js\/auth-client\.js\?v=5/, 'the service worker must precache the current OAuth callback client');
